...
def add_data_for_name(name_data, year, rank, name):
    ...
    if name not in name_data:
        ...
        for key in name_data:
            if key == name:
                dic = name_data[key]  # {year:rank}
                if year in dic:
                    dic[year] = rank if int(rank) < int(dic[year]) else dic[year]
                else:
                    dic[year] = rank
                name_data[name] = dic
...
def add_file(name_data, filename):
    ...
    Input:
        name_data (dict): dict holding baby name data   ex:name:{year:rank}
        filename (str): name of the file holding baby name data ex:
